...
private _encodedMessageEditField = _display displayCtrl ZEUS_MORSE_BOMB_DIALOG_ENCODED_MESSAGE_ID;
private _solutionMessageEditField = _display displayCtrl ZEUS_MORSE_BOMB_DIALOG_SOLUTION_MESSAGE_ID;
...
_encodedMessageEditField ctrlSetText "";
_solutionMessageEditField ctrlSetText "";
...
private _fnc_onConfirm = {
    ...
    private _encodedMessage = ctrlText (_display displayCtrl ZEUS_MORSE_BOMB_DIALOG_ENCODED_MESSAGE_ID);
    private _solutionMessage = ctrlText (_display displayCtrl ZEUS_MORSE_BOMB_DIALOG_SOLUTION_MESSAGE_ID);
    ...
    [attachedTo _logic, _bombTime, _shouldBeep, _maxDefuseAttempts, _encodedMessage, _solutionMessage, _explosionClassName, _removeShotVulnerabilityAfterDefuse, _serialNumber, _requireEOD, _requiredDefusalItems] call FUNC(moduleMorseBomb);
    deleteVehicle _logic;
};
