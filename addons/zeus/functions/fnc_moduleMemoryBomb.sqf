...
params ["_object", "_bombTime", "_shouldBeep", "_rounds", "_explosionClassName", "_serialNumber"];
...
if (_mouseOverType != "OBJECT") then {
    ...
    [_object, _bombTime, _shouldBeep, _rounds, _explosionClassName, _serialNumber] call EFUNC(main,init_memory_bomb_full);
